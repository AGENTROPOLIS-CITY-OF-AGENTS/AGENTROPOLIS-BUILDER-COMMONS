...
const required = [
  ...
  "spec/spatial-world.schema.json",
  "spec/spatial-interior.schema.json",
  ...
  "packages/compute-registry/src/registry.mjs",
  "packages/compute-router/src/router.mjs",
  "packages/model-adapter/src/contract.mjs",
  "packages/runtime-adapter/src/contract.mjs",
